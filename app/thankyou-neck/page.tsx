    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center min-h-screen px-4 py-5 bg-gradient-to-b pt-[100px] from-gray-900 to-black text-white text-center">
        ...
        <p className="text-base md:text-lg text-gray-300 max-w-xl mb-6">
          We have successfully received your inquiry about our neck & shoulder pain treatments. 
        ...
        <div className="bg-gray-800 p-6 rounded-lg max-w-2xl mb-8 text-left">
          <h2 className="text-xl font-bold mb-4 text-[#e13e20] text-center">Why Choose Ayush Ortho for neck & shoulder Pain?</h2>
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span><strong>23,500+</strong> neck & shoulder pain patients treated successfully</span>
            </li>
            <li className="flex items-start">
              <div className="bg-[#e13e20] rounded-full p-1 mr-3 mt-1">
                <div className="w-2 h-2 bg-white rounded-full"></div>
            ...
            <li className="flex items-start">
              ...
              <span>Tailored <strong>7, 14 & 21-Day Recovery Plans</strong> for neck & shoulder pains</span>
            </li>
            <li className="flex items-start">
              <div className="bg-[#e13e20] rounded-full p-1 mr-3 mt-1">
                <div className="w-2 h-2 bg-white rounded-full"></div>
