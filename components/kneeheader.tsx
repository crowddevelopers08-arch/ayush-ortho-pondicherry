        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <a href="#treatments" className="text-white hover:text-[#e13e20] transition-colors duration-300">
                Treatments
              </a>
            
              <a href="#reviews" className="text-white hover:text-[#e13e20] transition-colors duration-300">
                Reviews
              </a>
              <a href="#contacts" className="text-white hover:text-[#e13e20] transition-colors duration-300">
                Contacts
              </a>
            </nav>
