  ...
  return (
    <>
      ...
      >
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-14">
              <div className="lg:w-1/2 w-full">
                <h2 className="text-[42px] max-[470px]:text-[22px] max-[470px]:text-center max-[470px]:mb-3 mb-6 font-bold text-white leading-tight">
                  Back Pain Relief at <span className="text-orange-500">Ayush Ortho </span>- Puducherry
                </h2>

                <div className="bg-gray-800 p-4 rounded-lg mb-6 max-[470px]:mb-10">
                  <p className="text-gray-300 italic max-[470px]:text-center">
                    Struggling with back pain while sitting, standing, walking, or even resting?
                  </p>
                </div>
                ...
                <p className="text-gray-300 mb-6">
                  At Ayush Ortho, we address the root cause of back pain with non-surgical care using Ayurveda, Varma Therapy, Orthopaedic Manual Therapy, and Chiropractic Care.
                </p>
                ...
                <p className="text-orange-200 max-[325px]:text-[12px] max-[470px]:text-center mt-6 text-sm">
                  Non-surgical support for chronic back pain, posture strain, and disc-related discomfort
                </p>
              </div>
        ...
        <BackconsultationModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
      </div>
    </>
  );
}
